      ...
      <nav class="navbar bg-second p-0">
        <div class="container-fluid h-100 px-0" style="position: relative;">
          <div class="level p-0 m-0 h-100">
            <div class="level p-0 m-0 h-100">
              <a class="navbar-brand bg-primary d-flex justify-content-left align-items-center" href="#" style="height: 100%; width: 85%;">
                <div class="current-level d-flex align-items-center justify-content-center mh-100">
                  <div class="level-square bg-warning d-flex justify-content-center align-items-center" style="
                    width: 57px;
                    height: 57px">
          ...
          <button class="navbar-toggler" type="button" data-bs-toggle="offcanvas" data-bs-target="#navbar-offcanvas" aria-controls="navbar-offcanvas" style="border: none; outline: none;">
